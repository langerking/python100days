...
class Udemy:
    def __init__(self, course_url):
        ...
        time.sleep(5)
        expand_all = self.__driver.find_element(By.CSS_SELECTOR,
                                                '.curriculum--curriculum-sub-header--m_N_0 button.ud-btn-medium')
        time.sleep(2)
        # expand_all.click()
    ...
    def __course_contain(self):
        ...
        all_containers = self.__driver.find_elements(By.CLASS_NAME,
                                                     'accordion-panel-module--panel--3_kkG.section--panel--1zoAn')
        ...
        for single_container in all_containers:
            ...
            titles = single_container.find_elements(By.CSS_SELECTOR,
                                                    '.ud-unstyled-list.ud-block-list li div.section--row--3sLRB span')
